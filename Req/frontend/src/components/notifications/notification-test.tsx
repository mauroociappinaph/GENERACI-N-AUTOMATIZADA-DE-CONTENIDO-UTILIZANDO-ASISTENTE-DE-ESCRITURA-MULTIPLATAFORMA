    ...
    try {
      ...
      const testNotifications = {
        [NotificationType.INFO]: {
          ...
          message: 'Esta es una notificación de información para probar el sistema.',
        ...
        [NotificationType.USER_ACTION]: {
          ...
          data: { testType: 'user_action', timestamp: new Date().toISOString() }
        },
        [NotificationType.DATA_UPDATE]: {
          title: 'Actualización de datos',
          message: 'Los datos del sistema han sido actualizados.',
          data: { testType: 'data_update', timestamp: new Date().toISOString() }
        },
        [NotificationType.REPORT_READY]: {
          title: 'Reporte disponible',
          message: 'Su reporte solicitado está listo para descargar.',
          data: { testType: 'report_ready', timestamp: new Date().toISOString() }
        },
      };
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-sm text-gray-600">
            Utiliza este panel para probar el sistema de notificaciones en tiempo real.
          </p>
        </div>
        ...
        <div className="space-y-4">
          <h4 className="font-medium text-gray-900">Enviar Notificaciones de Prueba:</h4>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <Button
              onClick={() => sendTestNotification(NotificationType.REPORT_READY)}
              disabled={isLoading}
        ...
        <div className="p-4 bg-gray-50 rounded-lg">
          ...
          <ul className="text-sm text-gray-600 space-y-1">
            ...
            <li>• También se mostrarán en el centro de notificaciones (icono de campana)</li>
            <li>• El contador de notificaciones sin leer se actualizará automáticamente</li>
            <li>• Verifica que el WebSocket esté conectado para recibir notificaciones en tiempo real</li>
          </ul>
        </div>
      </div>
    </Card>
