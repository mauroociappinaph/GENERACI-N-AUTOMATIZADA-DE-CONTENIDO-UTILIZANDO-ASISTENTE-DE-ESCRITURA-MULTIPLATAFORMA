...
router.post(
  '/backups',
  requireRole(UserRole.ADMIN),
  SystemConfigController.createDatabaseBackup
);
...
router.get(
  '/backups',
  requireRole(UserRole.ADMIN),
  SystemConfigController.getDatabaseBackups
);
...
router.post(
  '/backups/:id/restore',
  requireRole(UserRole.ADMIN),
  SystemConfigController.restoreDatabaseBackup
);
...
router.post(
  '/logs/cleanup',
  requireRole(UserRole.ADMIN),
  SystemConfigController.cleanupOldLogs
);
...
router.get(
  '/metrics',
  requireRole(UserRole.ADMIN),
  SystemConfigController.getSystemMetrics
);
