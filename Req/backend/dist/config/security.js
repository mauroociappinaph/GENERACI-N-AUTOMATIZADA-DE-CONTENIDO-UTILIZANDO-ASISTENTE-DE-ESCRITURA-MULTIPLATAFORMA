...
exports.validateSecurityConfig = exports.getSecurityConfig = exports.securityConfig = void 0;
...
exports.securityConfig = {
    ...
    csp: {
        directives: {
            ...
            formAction: ["'self'"],
            frameAncestors: ["'none'"],
            upgradeInsecureRequests: index_1.config.nodeEnv === 'production' ? [] : null,
        },
        reportOnly: index_1.config.nodeEnv === 'development',
    },
    // HTTPS and TLS configuration
    https: {
        enabled: index_1.config.nodeEnv === 'production',
        forceHttps: index_1.config.nodeEnv === 'production',
    ...
    session: {
        secure: index_1.config.nodeEnv === 'production',
        httpOnly: true,
        sameSite: 'strict',
...
const getSecurityConfig = () => {
    return {
        ...
        ...(index_1.config.nodeEnv === 'development' && {
            https: {
                ...exports.securityConfig.https,
                enabled: false,
                forceHttps: false,
            },
            csp: {
                ...exports.securityConfig.csp,
                reportOnly: true,
            },
        }),
    };
...
const validateSecurityConfig = () => {
    ...
    const missing = requiredEnvVars.filter((envVar) => !process.env[envVar] || process.env[envVar] === 'fallback-secret-key');
    if (missing.length > 0) {
