 ...
 *         $ref: '#/components/responses/Unauthorized'
 */
router.get('/stats', notification_controller_1.notificationController.getStats.bind(notification_controller_1.notificationController));
/**
 * @swagger
 ...
 *         $ref: '#/components/responses/Unauthorized'
 */
router.patch('/mark-all-read', notification_controller_1.notificationController.markAllAsRead.bind(notification_controller_1.notificationController));
/**
 * @swagger
