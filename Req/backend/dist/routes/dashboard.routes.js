 ...
 */
router.get('/metrics', dashboard_controller_1.DashboardController.getDashboardMetrics);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/widgets', dashboard_controller_1.DashboardController.getUserWidgets);
/**
 * @swagger
 * /api/dashboard/widgets:
 *   post:
 ...
 *         description: Internal server error
 */
router.post('/widgets', dashboard_controller_1.DashboardController.saveWidgetConfiguration);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.post('/widgets/add', dashboard_controller_1.DashboardController.addWidget);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.delete('/widgets/:widgetId', dashboard_controller_1.DashboardController.deleteWidget);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/widgets/:widgetId/data', dashboard_controller_1.DashboardController.getWidgetData);
