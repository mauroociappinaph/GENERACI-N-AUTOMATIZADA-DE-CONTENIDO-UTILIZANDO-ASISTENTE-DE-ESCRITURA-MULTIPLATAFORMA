...
exports.testVectorDatabase = testVectorDatabase;
exports.performanceTest = performanceTest;
const vector_database_service_1 = require("../services/vector-database.service");
const debug_logger_1 = require("../utils/debug-logger");
const logger = (0, debug_logger_1.createComponentLogger)('VECTOR_DB_TEST');
/**
...
async function testVectorDatabase() {
    try {
        ...
        const vectorService = new vector_database_service_1.VectorDatabaseService();
        ...
        const searchResults = await vectorService.searchSimilar('machine learning and AI development', 3, 0.7);
        ...
        await vectorService.updateDocument('test-1', 'Updated content about advanced artificial intelligence and deep learning.', { type: 'test', category: 'ai', updated: true });
...
async function performanceTest() {
    try {
        ...
        const searchResults = await vectorService.searchSimilar('software development and programming technologies', 10, 0.5);
